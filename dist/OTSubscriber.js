  ...
  _createClass(OTSubscriber, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          style = _props.style,
          _props$pushSubscriber = _props.pushSubscriber,
          pushSubscriber = _props$pushSubscriber === undefined ? function () {} : _props$pushSubscriber;

      return _react2.default.createElement('div', { className: className, style: style, ref: function ref(node) {
          pushSubscriber(node);_this6.node = node;
        } });
    }
  }]);
...
OTSubscriber.propTypes = {
  ...
  pushSubscriber: _propTypes2.default.func,
