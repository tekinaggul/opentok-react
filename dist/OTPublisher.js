  ...
  _createClass(OTPublisher, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          style = _props.style,
          pushPublisher = _props.pushPublisher;

      var ref = function ref(node) {
        pushPublisher(node);_this6.node = node;
      };
      return _react2.default.createElement('div', { className: className, style: style, ref: ref });
    }
  }]);
...
OTPublisher.propTypes = {
  ...
  pushPublisher: _propTypes2.default.func,
...
OTPublisher.defaultProps = {
  session: null,
  className: '',
  pushPublisher: function pushPublisher() {},
  style: {},
  properties: {},
  eventHandlers: null,
  onInit: null,
